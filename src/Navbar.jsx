...
const Navbar = () => {
  return (
    <div>
        <div className='fixed top-0 left-0  w-full bg-black border-b border-white/10 backdrop-blur-xl z-50 text-[#f5e6d3] py-4 px-8 flex items-center justify-between'>
